-- LocalScript - Auto Collect Loot v21
...
-- Conexões para poder desconectar
...
-- Verificar se deve auto start (e limpar imediatamente)
local AUTO_START = false
if getgenv then
    AUTO_START = getgenv().AutoFarmStart == true
    getgenv().AutoFarmStart = nil -- Limpar imediatamente
end
...
-- Loops com thread ID para controle
