...
Converted["_VectorFrame"].Position = UDim2.new(-0.165646031, 316, 0.195544556, 53)
...
local function EBHXRT_fake_script() -- Fake Script: StarterGui.VectorGui.LocalScript
...
coroutine.wrap(EBHXRT_fake_script)()