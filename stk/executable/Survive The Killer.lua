-- LocalScript - Auto Collect Loot v16
...
local function teleportToEscape()
    ...
    local floorY = bouncerPos.Y
    
    -- Pegar Part[3] do Frame para altura do chão
    if doorway then
        ...
        if frame then
            ...
            -- Pegar a terceira Part
            if parts[3] then
                local part3 = parts[3]
                floorY = part3.Position.Y + (part3.Size.Y / 2) + 3
            end
        end
    end
